...
class TeXExample {
  static TeXViewWidget introduction = _teXViewWidget(
    r"""<h4>Flutter \( \rm\TeX \)</h4>""",
    r""" 
  ...
  static TeXViewWidget quadraticEquation = _teXViewWidget(
    r"<h4>Quadratic Equation</h4>",
    r"""
     When \(a \ne 0 \), there are two solutions to \(ax^2 + bx + c = 0\) and they are
     $$x = {-b \pm \sqrt{b^2-4ac} \over 2a}.$$<br>""",
  );

  static TeXViewWidget mathML = _teXViewWidget(
    r"<h4>MathML (MathJax Only)</h4>",
    r"""
<math xmlns = "http://www.w3.org/1998/Math/MathML">
  ...
  static TeXViewWidget bohrRadius = _teXViewWidget(
    r"<h4>Bohr's Radius</h4>",
  ...
  static TeXViewWidget chemistryEquations = _teXViewWidget(
    r"<h4>Chemistry Equations</h4>",
    r"""<p>    
     \( \ce{CO2 + C -> 2 CO} \) <br>
  ...
  static TeXViewWidget alignedTag = _teXViewWidget(
    r"<h4>Aligned Tag</h4>",
    r"""    
           $$
           \begin{aligned}
              ...
              child: Column(
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      Image.asset('assets/images/elev.png', width: 200),
                    ],
                  ),
                  SizedBox(height: 30),
                ],
            ...
            Column(
              children: [
                Row(
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: [
                    Icon(Icons.phone, color: AppTheme.color0081B9, size: 40),
                  ],
                ),
                Padding(
                ...
                Row(
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: [
                    Icon(Icons.email, color: AppTheme.color0081B9, size: 40),
                  ],
                ),
                Padding(
                  padding: const EdgeInsets.all(8.0),
                ...
                Row(
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: [
                    Icon(Icons.web_asset, color: AppTheme.color0081B9, size: 40),
                  ],
                ),
                Padding(
                  padding: const EdgeInsets.all(8.0),
                ...
                Row(
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: [
                    Icon(Icons.telegram, color: AppTheme.color0081B9, size: 40),
                  ],
                ),
                Padding(
                  padding: const EdgeInsets.all(8.0),
